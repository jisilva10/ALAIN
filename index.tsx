...
*   **Client Core Doc:**
    ...
    *   Secciones: Información Básica del Cliente, Contacto Estratégico y Roles, Historial de Proyectos con Profektus (si aplica), Necesidades Clave Identificadas, Desafíos Principales, Oportunidades Potenciales, Próximos Pasos Sugeridos para Profektus.
*   **Propuesta Doc:**
...
2.  **Propuesta (Proposal):** Generate proposals in Profektus format. You will first ask a specific block of questions to understand the workshop's problem/challenge. Then, structure the proposal with: Project Name (English, impactful, creative, unique), Mini Description (Spanish, max 50 chars, inspiring), General Objective (SMART, Bloom's Taxonomy), 3 Derived Opportunities, Specific Objectives (2-6, Bloom, SMART, max 400 chars), Program Details (sections with name, scope, methodology, product), and Investment (formatted block, data provided by consultant).
...
| **Diseño mixto**                                        | Combinado           | Integra métodos cuantitativos y cualitativos. Ideal para evaluaciones organizacionales amplias, como fusiones o reestructuraciones (Plano Clark & Creswell, 2014).                |
...
| ------------------------------------------------------ | ----------------------------- | ------------------------------------------------------------------------------------------ |
| **Estudio sobre intervención en bullying escolar**     | Cuantitativo experimental     | Aplicable a programas organizacionales de prevención del acoso laboral (mobbing).          |
...
| **Estudio sobre actividad física en escuelas**         | Cuantitativo no experimental  | Usado como modelo para estudios organizacionales sobre salud ocupacional o pausas activas. |
...
| Pirámide de necesidades de Maslow            | Abraham Maslow                            | Comprensión de la motivación en distintos niveles organizacionales.       |
...
| Criterio / Herramienta                          | Uso en procesos organizacionales                                       |
| ----------------------------------------------- | ---------------------------------------------------------------------- |
...
| **Modelo de Toma de Decisiones Racional**                          | Herbert Simon (adaptado por Robbins)       | Base para decisiones lógicas en entornos organizacionales.                        |
...
| **Conflictos organizacionales**                                 | Intrapersonal, Interpersonal, Intrarol, Interrol, Intergrupal.             |
...
| **Modelo de Toma de Decisiones Racional**                | Adaptado de Herbert Simon | Uso de lógica y pasos sistemáticos para decisiones organizacionales.      |
...
| --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tipos de estrategias organizacionales**                                               | Holbeche clasifica estrategias en: adaptativa, defensiva, prospectiva, y reactiva. RH debe adaptarse a cada tipo en su diseño de intervenciones.                                       |
...
| **Clasificación de capacidades organizacionales**                                       | Clasificadas en: capacidades técnicas, capacidades de innovación, capacidades relacionales y capacidades adaptativas. RH debe construirlas intencionalmente.                           |
...
| **Modelo de Intervención Psicológica Organizacional**  | Inspirado en Bronfenbrenner (1979)             | Diseño e implementación de cambios organizacionales.               | Intervenciones multinivel: individual, grupal, organizacional y entorno. Fases: diagnóstico, planificación, implementación, evaluación y retroalimentación.                                                                         |
...
| **Métodos Mixtos de Evaluación en Psicología Org.**    | Rothmann & Cooper (2022)                       | Comprensión profunda de fenómenos organizacionales complejos.      | Uso combinado de encuestas cuantitativas (e.g., Job Satisfaction Scale, Maslach Burnout Inventory) y técnicas cualitativas (entrevistas, grupos focales).                                                                            |
...
| 3. **Capacidad dialógica**         | La habilidad para mantener conversaciones organizacionales profundas y constantes entre niveles jerárquicos. Mejora la alineación estratégica.       |
...
| ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tipos de pruebas psicológicas en el trabajo**        | Conte y Landy clasifican en: pruebas de habilidades cognitivas, pruebas de personalidad, pruebas situacionales, entrevistas estructuradas, y evaluaciones de honestidad.                            |
...
| **Climas Organizacionales**                            | Conte y Landy distinguen climas orientados a seguridad, innovación, apoyo o control. Impactan compromiso, retención y bienestar.                                                                    |
...
| **Personalidad autótélica vs exótélica**      | La personalidad autótélica encuentra recompensa en la actividad misma; la exótélica depende de recompensas externas. En entornos organizacionales, fomentar lo autótélico mejora motivación intrínseca.                          |
...
| **Intervención para reducción de entropía psíquica**        | Aplicación de programas de reducción de estrés, mejora de foco y sentido personal. Fundamental en culturas organizacionales con alta carga emocional o multitarea. |
...
| **Estado mental colectivo**      | **Características**                                                            | **Indicadores organizacionales**                                              |
| -------------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- |
...
| **Clasificación / Tipología**                  | **Descripción y Aplicación Relevante**                                                                                                                                                                        |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tipos de documentos técnicos**               | Instructivos, manuales, informes técnicos, propuestas, políticas organizacionales, presentaciones, hojas de datos, white papers, mensajes internos, infografías y contenido web.                              |
...
| **Concepto Clave**                                 | **Definición y Aplicación Estratégica**                                                                                                                              |
| -------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Claridad estratégica**                           | Eliminar ambigüedades en procesos, políticas, manuales y mensajes críticos. Reduce riesgos legales, mejora eficiencia, facilita la toma de decisiones.               |
| **Audiencia como centro del proceso comunicativo** | Adaptar contenido según conocimiento previo, necesidades, cultura y contexto del receptor. Clave para onboarding, cambios organizacionales y entrenamiento.          |
...
| **Adaptación de contenidos para poblaciones multiculturales** | En compañías globales como Siemens o Unilever, adaptar lenguaje y símbolos técnicos redujo errores y mejoró engagement.                                              |
...
| **Tipo de riesgo narrativo**                  | **Descripción**                                                                 | **Consecuencias organizacionales**                           |
| --------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------ |
...
| **Framework de las 15 Lentes del Design Thinking Estratégico** | Idris Mootee                | Para reformular problemas y oportunidades organizacionales             | Incluye lentes como: cultura, modelos de negocio, experiencia de cliente, tecnología, liderazgo, comportamiento humano, estrategia social. Cada lente cambia la perspectiva del problema para encontrar nuevas soluciones. |
...
| **Diseño para escenarios futuros**                             | Idris Mootee                | Foresight estratégico e innovación disruptiva                          | Se utiliza diseño especulativo, narrativas estratégicas y diseño de futuros para anticipar desafíos y crear capacidades organizacionales adaptativas.                                                                      |
...
| **Problemas organizacionales según su nivel de ambigüedad** | Se tipifican en: 1) Simples, 2) Complejos, 3) Ambiguos, 4) Caóticos. El tipo determina el enfoque de diseño y el método de resolución.                                                                                                        |
...
| **Target + IDEO**                        | Aplicación de Design Thinking para rediseñar la experiencia de compra en tiendas físicas. El enfoque fue observar comportamientos reales, mapear emociones y rediseñar recorridos.                                    |
...
| **Análisis por lentes estratégicos**            | Usar cada una de las 15 lentes (valor, cultura, procesos, liderazgo, experiencia) para reevaluar la situación de la empresa desde ángulos múltiples. Método potente para reconfigurar estrategia. |
...
| **Cultura organizacional como sistema abierto** | Evaluar cómo la cultura facilita o bloquea el pensamiento innovador. Involucra revisar símbolos, rutinas, rituales y estructuras de poder informal.                                               |
...
| **Método Double Diamond aplicado a negocios**        | British Design Council (2005), adaptado por Beausoleil | Guía para la resolución de problemas empresariales                                                        | 1) Descubrir, 2) Definir, 3) Desarrollar, 4) Entregar. Beausoleil lo alinea con fases de ambigüedad estratégica y toma de decisiones basada en prototipos.                                                                                         |
| **Toolbox de 20 herramientas de diseño estratégico** | Compilación Beausoleil                                 | Aplicación práctica en facilitación de procesos y consultoría                                             | Incluye mapas de actores, arquetipos, modelado de comportamientos, pirámide de valor, mapas emocionales, entre otros. Se usan en combinación durante procesos iterativos.                                                                          |
...
| **Fjord (Accenture Interactive)** | Aplicación de Business Design para transformar servicios gubernamentales centrados en el ciudadano, desde insights emocionales hasta rediseño de journey y touchpoints.        |
...
interface ExportedProjectData {
    ...
    messages: StoredContent[];
    systemInstruction: string;
    activeFunctionAtExport: string | null;
    version: "1.0"; 
    compressionFormat?: "gzip_pako_v1";
}
...
const fileActionsBtn = document.getElementById('file-actions-btn') as HTMLButtonElement;
const filePopover = document.getElementById('file-popover') as HTMLDivElement;
const popoverExportBtn = document.getElementById('popover-export-btn') as HTMLButtonElement;
const popoverImportBtn = document.getElementById('popover-import-btn') as HTMLButtonElement;
...
function initializeApp() {
    ...
    popoverExportBtn.addEventListener('click', () => {
        handleExportConversation();
        filePopover.classList.remove('show');
    });
    popoverImportBtn.addEventListener('click', () => {
    ...
    window.addEventListener('click', (event) => {
        if (event.target === newChatModal) newChatModal.style.display = 'none';
        if (event.target === deleteChatConfirmModalElement) closeDeleteConfirmModal();
        
        // Close popover if clicked outside
        if (!filePopover.contains(event.target as Node) && !fileActionsBtn.contains(event.target as Node)) {
            filePopover.classList.remove('show');
        }
    });
...
function displayInitialWelcomeMessage() {
    chatMessages = [{
        ...
        sender: 'ai',
        text: "Bienvenido a A’LAIN Profektus AI Assistant. Por favor, crea un nuevo chat para comenzar, importa un proyecto existente (.aic) o selecciona una función si ya tienes un chat activo.",
        timestamp: new Date()
    }];
    renderMessages();
...
function createNewChat(clientName: string, topic: string) {
    ...
    const title = `${year}${month}${day}_${clientName.replace(/[\s\\/:*?"<>|]/g, "_")}_${topic.replace(/[\s\\/:*?"<>|]/g, "_")}`;
...
function loadChat(chatId: string) {
    ...
    session.messages.forEach((contentItem, index) => { 
...
function addMessageToChat(sender: Message['sender'], text: string, idSuffix?: string, explicitId?: string) {
    ...
    if (currentSession) {
        if (sender === 'user') {
            const content: StoredContent = { role: 'user', parts: [{ text }] }; 
...
function finalizeAIMessage(aiMessage: Message, collectedGroundingMetadata?: GroundingMetadata) {
    ...
    if (collectedGroundingMetadata?.groundingChunks && collectedGroundingMetadata.groundingChunks.length > 0) {
        const simplifiedChunks = collectedGroundingMetadata.groundingChunks
            .filter(gc => gc.web?.uri) 
            .map(gc => ({ 
                web: { 
                    uri: gc.web!.uri!, 
        ...
        if (simplifiedChunks.length > 0) {
            contentToSave.groundingMetadata = { 
                groundingChunks: simplifiedChunks
            };
        }
    }
...
function checkAIResponseForFunctionActivation(responseText: string): { id: string, name: string } | null {
    ...
    for (const func of functionButtonDetails) {
        ...
        const activationPatterns = [
            ...
            `guíame a través de la función ['"]?${funcNameLower}['"]?`, 
...
async function handleSendMessage() {
    ...
    addMessageToChat('ai', "A’LAIN está pensando", undefined, thinkingMessageId);

    await sendPromptToAI(prompt, thinkingMessageId);
}

async function sendPromptToAI(prompt: string, thinkingMessageIdToRemove?: string) {
    if (!currentChatSession) {
        addMessageToChat('error', "Error: No hay sesión de chat activa.", "no-active-session");
        return;
    }
    const currentSessionData = chatHistory.find(s => s.id === currentChatId);
    if (!currentSessionData) {
         addMessageToChat('error', "Error: No se encontró la sesión de chat actual en el historial.", "session-not-found");
         return;
    }
    ...
    const isGreeting = isFirstUserMessageInSession && isUserGreeting(prompt);
    ...
    if (isGreeting) {
        ...
        try {
            const sendMessageParams: SendMessageParameters = { message: prompt };
    ...
    chatMessages.forEach(msg => {
        ...
        if (msg.sender === 'ai' && msg.id.endsWith('-ai-thinking')) {
            ...
            if (msg.groundingChunks && msg.groundingChunks.length > 0) {
                const toolCodeAndJsonRegex = /<tool_code>[\s\S]*?<\/tool_code>\s*\[[\s\S]*?\]\s*/g;
                processedText = processedText.replace(toolCodeAndJsonRegex, '').trim();
            }
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                const ulListItemMatch = line.match(/^\s*([*+-\u25A0\u25A1\u25AA\u25AB\u25CF\u25CB\u25B6\u25C0•·‣⁃])\s+(.*)/); 
        ...
        if (msg.externalImageLinks && msg.externalImageLinks.length > 0) {
            ...
            linksTitle.textContent = "Imágenes de Referencia:"; 
        ...
        if (msg.sender === 'ai' && msg.groundingChunks && msg.groundingChunks.length > 0) {
            ...
            fuentesTitle.textContent = "Links de información relevante (Búsqueda):"; 
...
function updateFileActionsState() {
    popoverExportBtn.disabled = !currentChatId;
}
...
async function handleExportConversation() {
    ...
    if (!session) {
        alert("Error: No se encontró la sesión de chat activa.");
        return;
    }

    popoverExportBtn.disabled = true;
    const originalButtonText = popoverExportBtn.innerHTML;
    popoverExportBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Exportando...';

    try {
        const exportedData: ExportedProjectData = {
            ...
            systemInstruction: session.systemInstruction,
            activeFunctionAtExport: activeFunction,
            version: "1.0",
            compressionFormat: "gzip_pako_v1"
        };

        const jsonString = JSON.stringify(exportedData);
        const compressedBytes: Uint8Array = pako.deflate(jsonString);

        const clientPart = session.clientName.replace(/[\s\\/:*?"<>|]/g, "_").substring(0, 30);
        const topicPart = session.topic.replace(/[\s\\/:*?"<>|]/g, "_").substring(0, 40);
        const datePart = new Date().toISOString().split('T')[0];
        const filename = `${clientPart}_${topicPart}_${datePart}.aic`;
        ...
        updateFileActionsState(); 
        popoverExportBtn.innerHTML = originalButtonText;
    }
}
...
async function handleImportFileSelected(event: Event) {
    ...
    if (!file.name.toLowerCase().endsWith('.aic')) {
        alert("Por favor, seleccione un archivo .aic válido.");
        input.value = ''; 
        return;
    }
    ...
    reader.onload = async (e) => {
        try {
            ...
            const importedProject = JSON.parse(jsonString) as ExportedProjectData;

            if (!importedProject || importedProject.version !== "1.0") { 
                throw new Error("Datos de importación no válidos o versión incompatible.");
            }
            ...
            const newSession: ChatSession = {
                ...
                clientName: importedProject.clientName,
                topic: importedProject.topic,
                createdAt: now, 
                lastActivity: now, 
                messages: importedProject.messages,
                systemInstruction: importedProject.systemInstruction,
            };
            ...
            if (importedProject.activeFunctionAtExport) {
                activeFunction = importedProject.activeFunctionAtExport;
                setActiveFunctionTheme(activeFunction);
                renderFunctionButtons();
            }

            alert(`Proyecto "${importedProject.title}" importado exitosamente como un nuevo chat.`);

        } catch (error) {
            console.error("Error procesando archivo importado:", error);
            alert(`Error al importar el proyecto: ${error instanceof Error ? error.message : String(error)}`);
        } finally {
            input.value = ''; 
        }
    };
